<template>
  <section>
    <div class="row">
      <div class="col col-12 order-1 order-md-0 col-md-6 mb-3 ps-0 ps-md-5 text-start">
        <div class="d-flex">
        ...
        <p class="fs-4 f">
          ...
          Becoming a software engineer is my main<br>
          goal for now. For me learning something<br>
