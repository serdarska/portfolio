<template>
  <section>
    <div class="row">
      <div class="col col-12 order-0 col-md-6 my-3 text-start">
        <div class="d-flex">
      ...
      <div class="col col-12 order-1 col-md-6 my-3 text-start">
        ...
        <p class="fs-5">
          ...
          and since I started studying at FINKI,<br>
          editing and making new web <br>
          pages has become one of them.<br>
        </p>
      </div>
    </div>
  </section>
